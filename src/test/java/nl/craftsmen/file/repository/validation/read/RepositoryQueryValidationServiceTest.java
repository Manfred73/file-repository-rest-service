 ...
 */
@QuarkusTest
class RepositoryQueryValidationServiceTest {
	...
	@Inject
	RepositoryQueryValidationService cut;

	@Test
	@DisplayName("Given 2 validations, I expect that these are being executed")
	void expect_that_validations_are_being_executed() {
		...
		Assertions.assertThat(validations).hasSize(2);
	}
}