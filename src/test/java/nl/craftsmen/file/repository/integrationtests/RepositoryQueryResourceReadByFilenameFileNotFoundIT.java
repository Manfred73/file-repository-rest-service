...
class RepositoryQueryResourceReadByFilenameFileNotFoundIT {

	@Test
	@DisplayName("When a GET request is made with a filename as parameter, but the file does not exist, I expect a NotFoundException with a description")
	void expect_response_with_status_404_when_calling_get_with_filename_as_parameter_because_file_does_not_exist() {
		// GIVEN /  WHEN / THEN
		given()
				.pathParam("filename", "FILE.20160919.152122.149068")
				.when()
