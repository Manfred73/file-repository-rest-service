...
class RepositoryQueryResourceReadByFilenameSuccessIT {

	@Test
	@DisplayName("When a GET request is made with a filename as parameter, I expect the content of that file to be returned as response")
	void expect_response_with_status_200_and_body_with_file_content_when_calling_get_with_filename_as_parameter() {
		// GIVEN
		final var testParams = mockForGetWithFilenameAsParameterSuccess();
	...
	private TestParams mockForGetWithFilenameAsParameterSuccess() {
